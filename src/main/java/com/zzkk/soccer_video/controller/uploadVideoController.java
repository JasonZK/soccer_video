...
import com.zzkk.soccer_video.utils.FfmpegUtil;
...
/**
 * @ClassName uploadVideoController
 * @Description
...
public class uploadVideoController {
    ...
    //throws IllegalStateException写在方法的前面是可以抛出异常状态的，如果有错误会把错误信息发出来对应下面的try和catch
        ...
        try{
            ...
            //保存视频url路径地址
            String videoUrl = "http://localhost:" + serverIp + "/myvideos/" + newVideoName;
            //保存视频大小，单位转换为mb
